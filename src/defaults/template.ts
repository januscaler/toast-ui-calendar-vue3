export const getTemplate = ({ t, tm }) => ({
	...
	weekDayName: (model: any) =>
		`<div class="toastui-calendar-day-name-item toastui-calendar-week"><span style="font-size:1.1rem;">${model.date}</span>&nbsp;&nbsp;<span style="font-size:0.9rem;">${model.dayName}</span>&nbsp;&nbsp;<span style="font-size:0.9rem;">${model.dateInstance.getFullYear()}</span></div>`,
